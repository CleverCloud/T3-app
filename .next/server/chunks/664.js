...
const addLocale = function(path) {
    ...
    if (true) {
        return (0, _normalizetrailingslash.normalizePathTrailingSlash)((__webpack_require__(431).addLocale)(path, ...args));
    }
    return path;
};
if ((typeof exports.default === "function" || typeof exports.default === "object" && exports.default !== null) && typeof exports.default.__esModule === "undefined") {
...
const detectDomainLocale = function() {
    ...
    if (true) {
        return (__webpack_require__(539).detectDomainLocale)(...args);
    }
};
if ((typeof exports.default === "function" || typeof exports.default === "object" && exports.default !== null) && typeof exports.default.__esModule === "undefined") {
    Object.defineProperty(exports.default, "__esModule", {
...
function getDomainLocale(path, locale, locales, domainLocales) {
    if (true) {
        const normalizeLocalePath = (__webpack_require__(162).normalizeLocalePath);
        const detectDomainLocale = (__webpack_require__(249).detectDomainLocale);
...
const normalizeLocalePath = (pathname, locales)=>{
    if (true) {
        return (__webpack_require__(14).normalizeLocalePath)(pathname, locales);
    }
    return {
        pathname,
